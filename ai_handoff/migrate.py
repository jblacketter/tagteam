"""
Migration command for AI Handoff Framework.

Migrates projects that were set up before Phase 1 (without ai-handoff.yaml)
...
def migrate_command(args: list[str]) -> int:
    ...
    if not has_skills and not has_templates and not has_docs:
        ...
        print("Run 'python -m ai_handoff setup' to set up a new project.")
        return 1
