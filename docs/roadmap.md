...
- **Status:** ✅ Complete — plan approved round 1, impl approved round 1 (2026-09-20); gate: 2,148 passed, 5 skipped at `6295abf`. Branch `phase/roadmap-dependency-problems-name-their-line`; PR merge pending. See `docs/phases/roadmap-dependency-problems-name-their-line.md`.
