...
- **Status:** Planning — plan cycle opened 2026-09-20. Branch `phase/framework-provenance-from-earlier-releases`. See `docs/phases/framework-provenance-from-earlier-releases.md`.
