...
- **Status:** ✅ Approved — plan approved round 3 (2026-09-23), impl approved round 2 (2026-09-24); gate: 2,554 passed, 5 skipped at `241b4df`. PR open, merge pending. See `docs/phases/jobs-background-tasks-and-ci-watch.md`.
