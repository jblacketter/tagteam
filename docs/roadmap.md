...
- **Status:** In review — plan approved round 1 (2026-09-20); impl cycle opened 2026-09-20. Branch `phase/version-from-the-source-tree` (stacked on Phase 63's branch until PR #47 merges). See `docs/phases/version-from-the-source-tree.md`.
