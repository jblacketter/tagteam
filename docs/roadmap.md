...
- **Status:** ✅ Complete — plan approved round 1, impl approved round 3 (2026-09-20); gate: 2,112 passed, 5 skipped at `57088cf`. Branch `phase/version-from-the-source-tree` (stacked on Phase 63's branch until PR #47 merges); PR merge pending. See `docs/phases/version-from-the-source-tree.md`.
