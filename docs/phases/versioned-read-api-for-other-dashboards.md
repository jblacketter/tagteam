...
- [x] Complete: PR #61 merged 2026-09-24 (rebase). CI: the first PR run hit a pre-existing launchpad flake (also seen on main at d49c632); the re-run was green, watched by a Phase 72 `ci-watch` job.
